...
### 🗂️ Простые объяснения 

Это папка внутри репозитория Guidebook. [Здесь](https://github.com/Malakhova-Natalya/Guidebook/tree/main/Simple_explanations) будут собираться простые объяснения важных вещей в мире data engeneering. ✒️ 
